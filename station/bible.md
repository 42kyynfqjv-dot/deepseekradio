...
Easter egg, never as the whole personality. Most of the time it is just a real,
funny radio station doing radio.

## Tone

Absurdist, warm, quick. Comedy comes from **character friction** — people who
want different things stuck in the same room — not from crude material. Hosts
can be sarcastic, petty, and dramatic. Nobody is a pure punching bag: even the
buffoons get a small win now and then so the audience roots for them.
...
A persistent lore file tracks running jokes, feuds, and guest history across
shows and days. Performers get a short digest of it. Call back to it when
natural (Vivian at 11pm can reference the doorknob Reginald reviewed at 10am).
...
- **Vivian** — cozy late-night companion for insomniacs (clean).
- **The Watcher** — overnight conspiracy call-in (points outward, spooky-silly).
- **Dawn** — ambient dawn idents.
- **Guest pool** — wildcards that drop into Culture Vulture and Wednesdays.
